...
describe("UsersController", () => {
  ...
  it("Deve criar um novo usu\xE1rio com sucesso", async () => {
    const response = await (0, import_supertest.default)(app).post("/users").send({
      name: "Test User",
      // Define o nome do usuário de teste
      email: "testuser@example.com",
      // Define o email do usuário de teste
      password: "password123"
      // Define a senha do usuário de teste
    });
  ...
  it("Deve lan\xE7ar um erro se o usu\xE1rio com o mesmo email j\xE1 existir", async () => {
    const response = await (0, import_supertest.default)(app).post("/users").send({
      name: "Duplicate User",
      email: "testuser@example.com",
      password: "password123"
    ...
    expect(response.body.message).toBe(
      "Email j\xE1 cadastrado por outro usu\xE1rio!"
    );
  });
  it("Deve lan\xE7ar um erro de valida\xE7\xE3o se o email for inv\xE1lido", async () => {
    const response = await (0, import_supertest.default)(app).post("/users").send({
      name: "Test User",
      email: "invalid-email",
      password: "password123"
